...
use Laminas\Acl\Resource as AclResource;
    ...
    Resource
{
    ...
    {
        $results = $this->events()->triggerUntil(__FUNCTION__ . '.pre', $this, [], function ($result) {
        ...
        $this->events()->trigger(__FUNCTION__ . '.post-query', $this, ['items' => $items]);
        ...
        $this->events()->trigger(__FUNCTION__ . '.post', $this, ['items' => $items]);
        return $items;
    }
    ...
    public function get($id)
    {
        ...
        $results = $this->events()->triggerUntil(__FUNCTION__ . '.pre', $this, ['id' => $id], function ($result) use ($entityClass) {
        ...
        $this->events()->trigger(__FUNCTION__ . '.post', $this, ['entity' => $entity]);
    ...
    public function create($spec)
    {
        ...
        $this->events()->trigger(__FUNCTION__ . '.pre', $this, ['spec' => $spec]);
        ...
        $this->events()->trigger(__FUNCTION__ . '.post', $this, ['entity' => $spec]);
    ...
    public function update($id, $spec)
    {
        ...
        $this->events()->trigger(__FUNCTION__ . '.pre', $this, ['id' => $id, 'spec' => $spec]);
    ...
    public function delete($id)
    {
        ...
        $response = $this->events()->triggerUntil('delete.pre', $this, ['entity' => $entity], function ($result) {
        ...
        $this->events()->trigger('delete.post', $this, ['id' => $id, 'entity' => $entity]);
     ...
     *
     * Defined by Laminas\Acl\Resource
     *
     * @return string
     */
